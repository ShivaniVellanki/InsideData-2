...
// // To update the custom data when user activity changes:
// function updateUserActivityData(newData) {
//   // Update your tracking data
//   Object.assign(userActivityData, newData);

//   // If the chat is already initialized, you can update it
//   if (chatInstance) {
//     // Reinitialize with new data or use the SDK methods to update
//     chatInstance.updateBotInfo({
